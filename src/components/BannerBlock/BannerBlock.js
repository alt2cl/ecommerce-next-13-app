          ...
          <div className="relative mx-auto max-w-7xl px-8 sm:static sm:px-6 lg:px-20">
            <div className="sm:max-w-lg">
              ...
              <p className="mt-4 text-xl text-gray-500">
                Descubre Nuestras Irresistibles Recetas con Café para Enfriar
                Tus Días de Sol.
              </p>
            </div>
            <div>
              <div className="mt-10">
                ...
                <a
                  href="#"
                  className="inline-block rounded-md border border-transparent bg-primary px-8 py-3 text-center font-medium text-gray hover:bg-gray hover:text-white"
                >
                  Ver Recetas
                </a>
              </div>
