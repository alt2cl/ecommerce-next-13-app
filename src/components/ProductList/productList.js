    ...
    <>
      <div
        className={`grid grid-cols-2  ${
          countdata == 3 || cols == 3 ? "lg:grid-cols-3" : "lg:grid-cols-4"
        }  gap-4 lg:gap-10`}
      >
        {data.data.map((post) => {
          ...
          return (
            <div
              key={`product-${post.id}`}
              className={"flex flex-col gap-4 mb-5 lg:mb-16"}
            >
              ...
              <div className="flex flex-col col-span-4">
                <Link
                  ...
                  alt={"Ver producto:" + titulo}
                >
                  <h3 className="text-xl lg:text-2xl mb-3 font-semibold text-slate-900">
                    {titulo}
                  </h3>
                </Link>
                <p
