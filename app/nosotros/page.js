...
async function fetchNosotros() {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/ours?populate=*`,
    { next: { revalidate: 60 } }
  );
  return res.json();
}
    ...
    data.map(async (content) => {
      ...
      return await (
        <section
          ...
          style={{
            backgroundColor: content.attributes.Background ? "#f0ece7" : "",
            backgroundImage: content.attributes.Background
              ...
              : null,
            padding: content.attributes.Background ? "30px" : "",
          }}
        >
          <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            <div className="col-span-2">
              {content.attributes.imagen?.data && (
                <Image
                  src={
                    content.attributes.imagen?.data.attributes.formats?.medium
            ...
            <div className="col-span-3">
              ...
              <Link
                className="btn"
                href={`/${content.attributes.urlCallToAction}`}
              >
