...
function steps({ pasos }) {
  ...
  //       <div
  //         className={`${
  //           pasos == null ? "bg-slate-600 text-white" : "bg-slate-300"
  //         } rounded-full p-5 w-14 h-14`}
  //       >
  //         {" "}
  //         01{" "}
  //       </div>{" "}
  ...
  //       <div
  //         className={`${
  //           pasos == 2 ? "bg-slate-600 text-white" : "bg-slate-300"
  //         } rounded-full p-5 w-14 h-14`}
  //       >
  //         {" "}
  //         02{" "}
  ...
  //       <div
  //         className={`${
  //           pasos == 3 ? "bg-slate-600 text-white" : "bg-slate-300"
  //         } rounded-full p-5 w-14 h-14`}
  //       >
  //         {" "}
  //         03{" "}
